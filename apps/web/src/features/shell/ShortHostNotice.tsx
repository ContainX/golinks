...
export function ShortHostNotice({ app, onDismiss }: ShortHostNoticeProps) {
  ...
  return (
    <Alert severity="info" onClose={onDismiss} sx={{ mb: 3 }}>
      <AlertTitle>Make {shortHost}/ work in your browser</AlertTitle>
      ...
      <Box component="ol" sx={{ pl: 2.5, my: 1.5, display: 'grid', gap: 1 }}>
        <Typography component="li" variant="body2">
          <strong>A DNS record</strong>, which fixes it for everyone at once: ask whoever runs your
          network for an <Code>A</Code> or <Code>CNAME</Code> record for the bare name{' '}
